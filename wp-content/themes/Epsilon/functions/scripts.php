...
function wpex_load_scripts() {
	...
	*******************/
	...
	// Responsive
	global $data;
	if( $data['disable_responsive'] !== '1') wp_enqueue_style('wpex-responsive', WPEX_CSS_DIR . '/responsive.css');
	...
	*******************/
	...
	wp_enqueue_script('wpex-isotope-init', WPEX_JS_DIR .'/isotope_init.js', array('jquery'), '1.0', true);
	...
	// Google Maps
	wp_register_script('googlemap', WPEX_JS_DIR .'/googlemap.js', array('jquery'), '', true);

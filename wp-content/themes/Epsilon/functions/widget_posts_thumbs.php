...
class wpex_recent_posts_thumb extends WP_Widget {
                        ...
                        echo $before_title . $title . $after_title; ?>
							...
							<?php
                                ...
                                <?php if($featured_image) {  ?>
									<li class="clearfix">
										<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="title"><img src="<?php echo $featured_image; ?>" alt="<?php the_title(); ?>" /></a><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a>
    ...
    function form($instance) {	
	    $instance = wp_parse_args( (array) $instance, array( 'title' => __('Recent Posts','wpex'), 'select_post_type' => '', 'number' => '3', 'offset'=> '' ));					

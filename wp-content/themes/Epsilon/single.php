...
if( get_post_format() !== 'quote' ) { ?>
    <header id="page-heading">
        ...
        <ul class="meta clearfix">
            ...
            <?php if(comments_open()) { ?><li class="comment-scroll"><?php comments_popup_link(__('0 Comments', 'wpex'), __('1 Comment', 'wpex'), __('% Comments', 'wpex'), 'comments-link' ); ?></li><?php } ?>
        </ul>
    </header>
<?php } ?>
...
<div id="single-post-content" class="sidebar-bg container clearfix">
    ...
    <div id="post" class="clearfix">
        ...
        <?php
        // Show author bio if enabled in the theme panel
		if( $data['single_author_bio'] == '1' ) {
